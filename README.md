...
1. **Check Existing Issues:** Before starting any work, please check the [Issues](https://codeberg.org/kaimanhub/MastodonBot.ex/issues) section to see if your enhancement or bug fix is already being discussed.
