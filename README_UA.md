...
1. **Перевірте існуючі Issue:** Перед початком роботи перевірте розділ [Issues](https://codeberg.org/kaimanhub/MastodonBot.ex/issues), щоб дізнатися, чи вже обговорюється ваше вдосконалення або виправлення помилки.
